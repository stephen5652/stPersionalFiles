...
local mappings = {
  ["<leader>"] = {
    ...
    d = {
      ...
      c = { "<cmd>lua require'dap'.run_to_cursor()<CR>", "(<Leader>rc)运行到当前光标处", which_key_opts},
    },
    e = {
      name = "File explorer",
    ...
    w = {
      ...
      a = { "<cmd>lua require'telescope.builtin'.colorscheme()<cr>", "Appearance colorscheme list", which_key_opts},
